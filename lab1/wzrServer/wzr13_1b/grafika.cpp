...
void RysujScene()
{
	...
	GLfloat DGreenSurface[] = { 0.0f, 0.8f, 0.2f, 0.5f};
	GLfloat RedSurface[] = { 0.8f, 0.2f, 0.1f, 0.5f};
	GLfloat GreenSurface[] = { 0.45f, 0.65f, 0.15f, 1.0f};
	GLfloat YellowSurface[] = { 0.75f, 0.75f, 0.0f, 1.0f};
  GLfloat LYellowSurface[] = { 1.0f, 1.0f, 0.8f, 1.0f};
  ...
  glTranslatef(pMojObiekt->wPol.x,pMojObiekt->wPol.y+400,pMojObiekt->wPol.z+4000);
  //glTranslatef(0,300,5000);
  gluDisk(Qdisk,0,100,40,40);

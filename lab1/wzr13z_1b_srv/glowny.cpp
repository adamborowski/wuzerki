/****************************************************
    ...
    Do zadañ dotycz¹cych wspó³pracy, ekstrapolacji i autonomicznych agentów
 ****************************************************/
               ...
               int       nCmdShow)
{
	...
	bêdzie widoczne na ekranie */
 	okno = CreateWindow(nazwa_klasy, "Wspó³praca w cyberprzestrzeni", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
						100, 50, 1, 1, NULL, NULL, hInstance, NULL);
